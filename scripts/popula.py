...
logging.basicConfig()
logger = logging.getLogger("tredf.intranet.popula")
...
AREAS = {
    "/estrututura": {
        ...
        "@type": "Document",
        "title": "Áreas",
        "description": "Áreas do TRE-DF",
    },
    "/colaboradores": {
        "id": "colaboradores",
        "@type": "Document",
        "title": "Colaboradores",
        "description": "Colaboradores do TRE-DF",
    },
    "/estrututura/secom": {
        "id": "secom",
        "@type": "Area",
...
for idx in range(1, 500):
    ...
    data = {
        ...
        "email": f"{username}@tre-df.jus.br",
    }
    path = data["id"]
